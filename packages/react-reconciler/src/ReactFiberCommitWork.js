...
function hideOrUnhideAllChildrenOnFiber(fiber, isHidden) {
  ...
  switch (fiber.tag) {
    ...
    case LegacyHiddenComponent: {
      const offscreenState = fiber.memoizedState;
...
function hideOrUnhideNearestPortals(parentFiber, isHidden) {
  if (!supportsMutation) {
    return;
  }
...
function hideOrUnhideNearestPortalsOnFiber(fiber, isHidden) {
  if (!supportsMutation) {
    return;
  }
  switch (fiber.tag) {
