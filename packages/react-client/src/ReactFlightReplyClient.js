...
export function registerBoundServerReference(
  reference,
  id,
  bound,
  encodeFormAction,
...
function bind() {
  ...
  if (referenceClosure.bound !== null) {
    boundPromise = Promise.resolve((referenceClosure.bound)).then(
...
export function createBoundServerReference(
  metaData,
  callServer,
  encodeFormAction,
